...
export default function PCAPlot({ coords, sampleNames, labels, explainedVariance }) {
    ...
    const layout = {
        xaxis: { title: `PC1 (${pc1Var}%)`, gridcolor: 'rgba(148,163,184,0.1)', zeroline: true, zerolinecolor: 'rgba(148,163,184,0.2)' },
        yaxis: { title: `PC2 (${pc2Var}%)`, gridcolor: 'rgba(148,163,184,0.1)', zeroline: true, zerolinecolor: 'rgba(148,163,184,0.2)' },
